          ...
          <div className="tldr-grid">
            <div className="tldr-card highlight">
              ...
              <ul>
                ...
                <li>
                  Want a unified solution for managing access to LLMs through <strong>AI Gateway</strong>
                </li>
              </ul>
            </div>
            <div className="tldr-card">
              ...
              <ul>
                ...
                <li>
                  ...
                  <strong>manual prompt engineering</strong> and testing
                </li>
                <li>
                  Want a built-in <strong>prompt playground</strong> for interactive testing
                </li>
              </ul>
            </div>
          </div>
